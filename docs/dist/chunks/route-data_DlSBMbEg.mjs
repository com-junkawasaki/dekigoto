...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"api/configuration":"/src/content/docs/api/configuration.md","index":"/src/content/docs/index.md","architecture/merkle-dag":"/src/content/docs/architecture/merkle-dag.md","architecture/process-network":"/src/content/docs/architecture/process-network.md","components/security-gateway":"/src/content/docs/components/security-gateway.md","getting-started/installation":"/src/content/docs/getting-started/installation.md","getting-started/overview":"/src/content/docs/getting-started/overview.md","getting-started/quick-start":"/src/content/docs/getting-started/quick-start.md","components/eventstore":"/src/content/docs/components/eventstore.md"}}};
