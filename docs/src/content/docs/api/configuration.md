...
projection:
  worker_count: 2
  max_memory_mb: 256
  auto_promote_qps_threshold: 5.0
  auto_demote_qps_threshold: 0.5

security:
  mtls_enabled: false
  jwt_issuer: "actordb-dev"
  jwt_lifetime_sec: 3600
  jws_secret: "dev-secret-key"
  audit_stream_enabled: true
...
cluster:
  name: "prod-cluster"
  nodes:
    - "actordb-01.prod.example.com"
    - "actordb-02.prod.example.com"
    - "actordb-03.prod.example.com"

eventstore:
  data_dir: "/data/actordb"
  ...
  storage:
    type: "postgresql"
    connection_string: "postgresql://actordb:${DB_PASSWORD}@db.prod.example.com:5432/actordb"
...
security:
  mtls_enabled: true
  jwt_issuer: "actordb.prod.example.com"
  jwt_lifetime_sec: 1800
  jws_secret: "${JWT_SECRET}"
  audit_stream_enabled: true
  spiffe_trust_domain: "prod.example.com"
...
This comprehensive configuration system allows ActorDB TypeScript to be finely tuned for different deployment scenarios while maintaining type safety and validation.
